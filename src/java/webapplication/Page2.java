 ...
 *
 * @version Page2.java
 * @version Created on 05/04/2018, 12:10:07 PM
 * @author jaranda
 */
...
public class Page2 extends AbstractPageBean {
    ...
    private void _init() throws Exception {
        dropDown1DefaultOptions.setOptions(new com.sun.webui.jsf.model.Option[]{new com.sun.webui.jsf.model.Option("item1", "White"), new com.sun.webui.jsf.model.Option("item2", "Blue"), new com.sun.webui.jsf.model.Option("item3", "Green")});
        dropDown1DefaultOptions.setSelectedValue("item2");
        radioButtonGroup1DefaultOptions.setOptions(new com.sun.webui.jsf.model.Option[]{new com.sun.webui.jsf.model.Option("item1", "Blue"), new com.sun.webui.jsf.model.Option("item2", "White"), new com.sun.webui.jsf.model.Option("item3", "Green")});
