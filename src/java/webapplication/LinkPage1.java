 ...
 *
 * @version Link1.java
 * @version Created on 05/04/2018, 04:36:00 PM
 * @author jaranda
 */

public class LinkPage1 extends AbstractPageBean {
    ...
    private void _init() throws Exception {
        doubleRangeValidator1.setMaximum(10.0);
        doubleRangeValidator1.setMinimum(1.0);
        ...
        numberConverter1.setLocale(new java.util.Locale("en", "US", ""));
    ...
    public void init() {
        ...
        try {
            ...
            log("Link1 Initialization Failure", e);
